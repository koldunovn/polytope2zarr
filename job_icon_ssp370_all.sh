...
#SBATCH --output=icon_ssp_all_%j.out
#SBATCH -e icon_ssp_all_%j.err

# limit stacksize and core file size
ulimit -s 204800
ulimit -c 0

echo "Model: icon, Experiment: ssp3-7.0 (ALL monthly sfc and o2d variables)"
