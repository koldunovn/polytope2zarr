...
#SBATCH --output=ifsf_hist_3d_%j.out
#SBATCH -e ifsf_hist_3d_%j.err

# limit stacksize and core file size
ulimit -s 204800
ulimit -c 0

echo "Model: ifs-fesom, Experiment: historical (3D data: o3d + pl)"
...
O3D_NLEVELS=69  # ifs-fesom has 69 ocean levels
