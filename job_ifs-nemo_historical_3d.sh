...
#SBATCH --output=ifsn_hist_3d_%j.out
#SBATCH -e ifsn_hist_3d_%j.err

# limit stacksize and core file size
ulimit -s 204800
ulimit -c 0

echo "Model: ifs-nemo, Experiment: historical (3D data: o3d + pl)"
...
O3D_NLEVELS=75  # ifs-nemo has 75 ocean levels
