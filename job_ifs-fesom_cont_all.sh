...
#SBATCH --output=ifsf_cont_all_%j.out
#SBATCH -e ifsf_cont_all_%j.err

# limit stacksize and core file size
ulimit -s 204800
ulimit -c 0

echo "Model: ifs-fesom, Experiment: control (ALL monthly sfc and o2d variables)"
