...
#SBATCH --output=ifsn_cont_all_%j.out
#SBATCH -e ifsn_cont_all_%j.err

# limit stacksize and core file size
ulimit -s 204800
ulimit -c 0

echo "Model: ifs-nemo, Experiment: control (ALL monthly sfc and o2d variables)"
