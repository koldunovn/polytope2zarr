#!/bin/bash
#SBATCH --job-name=story_hist_r3_all
...
#SBATCH --output=story_hist_r3_all_%j.out
#SBATCH -e story_hist_r3_all_%j.err

ulimit -s 204800
ulimit -c 0

echo "Model: ifs-fesom, Activity: story-nudging, Experiment: hist, Realization: 3"
