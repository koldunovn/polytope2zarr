#!/bin/bash
#SBATCH --job-name=story_hist_r3_3d
...
#SBATCH --output=story_hist_r3_3d_%j.out
#SBATCH -e story_hist_r3_3d_%j.err

ulimit -s 204800
ulimit -c 0

echo "Model: ifs-fesom, Activity: story-nudging, Experiment: hist, Realization: 3 (3D data)"
