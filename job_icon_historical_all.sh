...
#SBATCH --output=icon_hist_all_%j.out
#SBATCH -e icon_hist_all_%j.err

# limit stacksize and core file size
ulimit -s 204800
ulimit -c 0

echo "Model: icon, Experiment: historical (ALL monthly sfc and o2d variables)"
