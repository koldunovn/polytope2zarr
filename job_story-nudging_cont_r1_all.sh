#!/bin/bash
#SBATCH --job-name=story_cont_r1_all
...
#SBATCH --output=story_cont_r1_all_%j.out
#SBATCH -e story_cont_r1_all_%j.err

ulimit -s 204800
ulimit -c 0

echo "Model: ifs-fesom, Activity: story-nudging, Experiment: cont, Realization: 1"
