...
#SBATCH --output=ifsf_hist_all_%j.out
#SBATCH -e ifsf_hist_all_%j.err

# limit stacksize and core file size
ulimit -s 204800
ulimit -c 0

echo "Model: ifs-fesom, Experiment: historical (ALL monthly sfc and o2d variables)"
